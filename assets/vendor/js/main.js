...
var _user$project$Keys$keyCodeToKey = _elm_lang$core$Dict$fromList(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 65, _1: _user$project$Keys$C2},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 87, _1: _user$project$Keys$CS2},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 83, _1: _user$project$Keys$D2},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 69, _1: _user$project$Keys$DS2},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 68, _1: _user$project$Keys$E2},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: 70, _1: _user$project$Keys$F2},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 84, _1: _user$project$Keys$FS2},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 71, _1: _user$project$Keys$G2},
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 89, _1: _user$project$Keys$GS2},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 72, _1: _user$project$Keys$A2},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 85, _1: _user$project$Keys$AS2},
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 74, _1: _user$project$Keys$B2},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 75, _1: _user$project$Keys$C3},
														_1: {ctor: '[]'}
													}
												}
											}
	...
	return A2(
		...
		A2(
			...
			A2(
				...
				A2(_elm_lang$core$List$range, 1, model.total_beats))));
};
var _user$project$Main$stepEditorHeader = A2(
	...
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Sequencer'),
		_1: {ctor: '[]'}
	});
...
var _user$project$Main$decodeCell = A4(
	...
	A2(_elm_lang$core$Json_Decode$field, 'track_id', _elm_lang$core$Json_Decode$int),
	A2(_elm_lang$core$Json_Decode$field, 'is_active', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int));
var _user$project$Main$decodeBpm = A2(_elm_lang$core$Json_Decode$field, 'bpm', _elm_lang$core$Json_Decode$int);
var _user$project$Main$beatCount = A2(_elm_lang$core$List$range, 1, 16);
var _user$project$Main$labChannelName = 'lab:room:';
var _user$project$Main$socketServer = 'ws://localhost:4000/socket/websocket';
var _user$project$Main$LabFlags = function (a) {
	return {lab_id: a};
};
var _user$project$Main$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {tracks: a, total_beats: b, current_beat: c, current_key: d, is_playing: e, phxSocket: f, bpm: g, lab_id: h};
	});
			...
			A2(
				_elm_lang$core$List$append,
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('sample'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
...
var _user$project$Main$stepEditor = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('table table-hover table-bordered'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Main$stepEditorTableHeader(model),
			_1: {
				ctor: '::',
				_0: _user$project$Main$stepEditorTracks(model),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Main$stepEditorSection = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('sequencer'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
			_0: _user$project$Main$stepEditorHeader,
			_1: {
				ctor: '::',
				_0: _user$project$Main$stepEditor(model),
				_1: {ctor: '[]'}
			}
		});
};
...
var _user$project$Main$initPhxSocket = function (lab_id) {
	return A4(
		_fbonetti$elm_phoenix_socket$Phoenix_Socket$on,
		'update_bpm',
		A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$labChannelName, lab_id),
...
var _user$project$Main$initModel = F2(
	function (labFlags, tracks) {
		return {
			tracks: tracks,
			total_beats: _elm_lang$core$List$length(_user$project$Main$beatCount),
			is_playing: false,
			phxSocket: _user$project$Main$initPhxSocket(labFlags.lab_id),
			...
			case 'SendUpdatedCell':
				...
				var push_ = A2(
					...
					A2(
						...
						'update_cell',
						A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$labChannelName, model.lab_id)));
			...
			case 'SendBpmUpdate':
				...
				var push_ = A2(
					...
					A2(
						...
						'update_bpm',
						A2(_elm_lang$core$Basics_ops['++'], _user$project$Main$labChannelName, model.lab_id)));
				var _p11 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push_, model.phxSocket);
...
var _user$project$Main$init = function (labFlags) {
	var model = A2(
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Main$bass_key_down(model.current_key),
				_1: {
					ctor: '::',
					_0: _user$project$Main$base_key_up(model.current_key),
					_1: {ctor: '[]'}
				}
			}
		});
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-play'),
							_1: {ctor: '[]'}
						},
						{ctor: '[]'}),
					_1: {ctor: '[]'}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('glyphicon glyphicon-stop'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {ctor: '[]'}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Main$stepEditorSection(model),
			_1: {
				ctor: '::',
...
var _user$project$Main$main = _elm_lang$html$Html$programWithFlags(
	...
	A2(
		...
		A2(_elm_lang$core$Json_Decode$field, 'lab_id', _elm_lang$core$Json_Decode$string)));
