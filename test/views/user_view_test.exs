defmodule ColabWeb.UserViewTest do
  use ColabWeb.ConnCase, async: true
  import Phoenix.View
  alias Colab.User

  test "new.html displays new user form", %{conn: conn} do
    content = render_to_string(ColabWeb.UserView, "new.html", conn: conn, changeset: User.changeset(%User{}))
  ...
  test "show.html displays user profile", %{conn: conn} do
    ...
    content = render_to_string(ColabWeb.UserView, "show.html", conn: conn, user: user)
